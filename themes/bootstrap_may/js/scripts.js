...
+function(a) {
    ...
    function c(a) {
        ...
        j - a > k ? //if scrolling up...
        e.removeClass("is-hidden") : a - j > k && a > l && //if scrolling down...
        e.addClass("is-hidden");
    }
    function d(a) {
        //secondary nav below intro section - sticky secondary nav
        var b = g.offset().top - f.height() - e.height();
        j >= a ? //if scrolling up... 
        a < b ? (//secondary nav is not fixed
        e.removeClass("is-hidden"), f.removeClass("fixed slide-up"), g.removeClass("secondary-nav-fixed")) : j - a > k && (//secondary nav is fixed
        e.removeClass("is-hidden"), f.removeClass("slide-up").addClass("fixed"), g.addClass("secondary-nav-fixed")) : //if scrolling down...	
        a > b + l ? (//hide primary nav
